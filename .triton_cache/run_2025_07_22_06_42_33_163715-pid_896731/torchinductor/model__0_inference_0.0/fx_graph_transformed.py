class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[128, 256]", arg1_1: "f32[128]", arg2_1: "f32[256, 256]", arg3_1: "f32[128]", arg4_1: "f32[256, 128]", arg5_1: "f32[256]"):
        ...
        mm_default: "f32[256, 128]" = torch.ops.aten.mm.default(arg2_1, permute);  arg2_1 = permute = None
        add_tensor: "f32[256, 128]" = torch.ops.aten.add.Tensor(mm_default, arg1_1);  mm_default = arg1_1 = None
        
         # File: /root/TorchForge/main.py:19 in forward, code: x = self.relu(x)
        relu: "f32[256, 128]" = torch.ops.aten.relu.default(add_tensor);  add_tensor = None
